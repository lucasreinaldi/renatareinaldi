...
<asp:Content ID="Content2" ContentPlaceHolderID="contentBody" runat="server">
	...
	<div class="container gerUsuarios">
    	<h2>Usuários cadastrados</h2>
    	 


        <asp:Panel ID="Panel1" runat="server" DefaultButton="btnUsuarios" CssClass="divUsuarios">
                    ...
                    <asp:RegularExpressionValidator ID="validador2" Font-Size="Smaller"
                        ...
                        <asp:LinkButton ID="btnUsuarios" runat="server" CssClass="btn btn-info"
    ...
    <div class="container wow fadeInUp delay-04s tabelaUsuarios">
